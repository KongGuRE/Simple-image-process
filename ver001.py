...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icon/iconmonstr-paintbrush-1-240.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap("icon/iconmonstr-paintbrush-1-240 - ON.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.btn_paintbrush.setIcon(icon1)
        ...
        self.spbox_paintbrus_size = QtWidgets.QSpinBox(self.gridWidget)
        self.spbox_paintbrus_size.setObjectName("spbox_paintbrus_size")
        self.horizontalLayout.addWidget(self.spbox_paintbrus_size)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/iconmonstr-paint-bucket-10-240.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap("icon/iconmonstr-paint-bucket-10-240 - ON.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.btn_floodfill.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icon/iconmonstr-undo-2-240.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("icon/iconmonstr-undo-2-240 - ON.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icon/iconmonstr-save-1-240.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icon/iconmonstr-paintbrush-7-240.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap("icon/iconmonstr-paintbrush-7-240 - ON.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.btn_color_palette.setIcon(icon5)
        ...
        self.action12 = QtWidgets.QAction(self)
        self.action12.setObjectName("action12")
        self.action15 = QtWidgets.QAction(self)
